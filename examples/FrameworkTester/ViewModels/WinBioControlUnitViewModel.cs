...
namespace FrameworkTester.ViewModels
{
    ...
    public sealed class WinBioControlUnitViewModel : WinBioSessionViewModel, IWinBioControlUnitViewModel
    {

        #region Constructors

        public WinBioControlUnitViewModel()
        {
        ...
        public override string Name => "WinBioControlUnit";
